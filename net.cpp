...
static const char *strMainNetDNSSeed[][2] = {
    {"phoenixconnect.coin", "52.66.84.190"},   
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"phoenixconnect.coin", "testnet-seed.phoenixconnecttools.com"},
    {"phoenixconnect.com", "testnet-seed.phx.xurious.com"},
    {"phx-testnet.com", "dnsseed.phx-testnet.com"},
    {NULL, NULL}
};
